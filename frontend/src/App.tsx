...
import {
  ...
  ExpressionsCreate,
  ExpressionsEdit,
} from './resources/Expressions';
import {
  UserInteractionsList,
  UserInteractionsCreate,
  UserInteractionsEdit,
} from './resources/UserInteractions';
import { UserList, UserCreate, UserEdit } from './resources/User';
import CharacterIcon from '@mui/icons-material/EmojiPeople';
import ExpressionsIcon from '@mui/icons-material/ChatBubble';
import UserInteractionsIcon from '@mui/icons-material/Forum';
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a7100ce3d">
      <Admin
        authProvider={
      ...
      >
        <Resource
          name="Character"
          options={{ label: 'Character' }}
          list={CharacterList}
          create={CharacterCreate}
          edit={CharacterEdit}
          recordRepresentation="characterName"
          icon={CharacterIcon}
        />
        <Resource
          name="Expressions"
          options={{ label: 'Expressions' }}
          list={ExpressionsList}
          create={ExpressionsCreate}
          edit={ExpressionsEdit}
          recordRepresentation="expressionText"
          icon={ExpressionsIcon}
        />
        <Resource
          name="UserInteractions"
          options={{ label: 'User Interactions' }}
          list={UserInteractionsList}
          create={UserInteractionsCreate}
          edit={UserInteractionsEdit}
          recordRepresentation="question"
          icon={UserInteractionsIcon}
        />
        <Resource
          name="User"
          options={{ label: 'User' }}
